...
namespace Starwars
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var query = planets.Where(p => p.Name.StartsWith("M"));
            ...
            var query2 = planets.Where(p => p.Name.Contains("y") || p.Name.Contains("Y"));

            foreach (var planet in query2)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query3 = planets.Where(p => p.Name.Length > 9 && p.Name.Length < 15);

            foreach (var planet in query3)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query4 = planets.Where(p => p.Name.IndexOf("a") == 1 && p.Name.LastIndexOf("e") == p.Name.Length - 1);

            foreach (var planet in query4)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query5 = planets.Where(p => p.RotationPeriod > 40).OrderBy(p => p.RotationPeriod);

            foreach (var planet in query5)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query6 = planets.Where(p => p.RotationPeriod > 10 && p.RotationPeriod < 20).OrderBy(p => p.Name);

            foreach (var planet in query6)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query7 = planets.Where(p => p.RotationPeriod > 30).OrderBy(p => p.RotationPeriod).OrderBy(p => p.Name);

            foreach (var planet in query7)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query8 = planets.Where(p => p.RotationPeriod < 30 && p.Name.Contains("ba") || p.SurfaceWater > 50 && p.Name.Contains("ba")).OrderBy(p => p.RotationPeriod).OrderBy(p => p.SurfaceWater).OrderBy(p => p.Name);

            foreach (var planet in query8)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query9 = planets.Where(p => p.SurfaceWater > 0).OrderByDescending(p => p.SurfaceWater);

            foreach (var planet in query9)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query10 = planets.Where(p => p.Diameter != 0 && p.Population != 0).OrderBy(p => (4 * Math.PI * Math.Pow(p.Diameter/2, 2)) / p.Population);

            foreach (var planet in query10)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            #region Opgave 11
            Console.WriteLine("\n---{Opgave 11}---");
            var query11List = planets.Where(p => p.RotationPeriod > 0);
            var query11 = planets.Except(query11List, new NameComparer());

            foreach (var planet in query11)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query12v1 = planets.Where(p => p.Name.ToLower().StartsWith("a") || p.Name.ToLower().EndsWith("s"));
            var query12v2 = planets.Where(p => p.Terrain != null && p.Terrain.Contains("rainforests"));

            var query12 = query12v1.Union(query12v2);

            foreach (var planet in query12)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query13 = planets.Where(p => p.Terrain != null && p.Terrain.Contains("deserts"));

            foreach (var planet in query13)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            var query14 = planets.Where(p => p.Terrain != null && p.Terrain.Contains("swamps")).OrderBy(p => p.RotationPeriod).ThenBy(p => p.Name);

            foreach (var planet in query14)
            {
                Console.WriteLine(planet.Name);
            }
            #endregion
            ...
            //var query15 = planets.Where(p => regex.Match(p.Name.ToLower));

            //foreach (var planet in query15)
            //{
            //    Console.WriteLine(planet.Name);
            //}
            //#endregion
            ...
            //Console.WriteLine("\n---{Opgave 16}---");
            //Regex regex = new Regex(@"[a]{2,}|[e]{2,}|[o]{2,}|[i]{2,}|[o]{2,}|[y]{2,}");
            //var query16 = planets.Where(p => regex.Match(p.Name.ToLower));

            //foreach (var planet in query16)
            //{
            //    Console.WriteLine(planet.Name);
            //}
            //#endregion
